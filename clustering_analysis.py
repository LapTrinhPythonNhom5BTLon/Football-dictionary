...
# Thêm cmap='viridis' để màu sắc đẹp hơn và alpha để nhìn rõ các điểm chồng lên nhau
scatter = plt.scatter(X_2d[:, 0], X_2d[:, 1], c=df["cluster"], cmap='viridis', alpha=0.6)
plt.colorbar(scatter, label='Cluster ID') # Thêm thanh chú thích màu

# --- PHẦN THÊM MỚI: Chú thích tên cầu thủ ---
import random
# Chọn ra 15 chỉ số ngẫu nhiên từ danh sách cầu thủ
...
# Thêm góc nhìn nghiêng để thấy rõ chiều sâu của các cụm
